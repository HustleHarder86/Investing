...
const quickAnswer = "When the Ontario Court of Appeal released its decision in Hartshorne v. Hartshorne last month, family lawyers across the province took notice. The...";
