        ...
        <div className="prose prose-slate max-w-none">
          <section className="mb-8">
            ...
            <p className="text-slate-600">
              By accessing or using ProsperBridge Financial Advisory services, you agree to be bound by these Terms of Service. If you disagree with any part of these terms, you may not access our services.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-display font-bold text-slate-900 mb-4">2. Services Description</h2>
            <p className="text-slate-600 mb-4">ProsperBridge provides financial planning and advisory services including:</p>
          ...
          <section className="mb-8">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 text-amber-900">
              ...
              <p>
                ProsperBridge provides financial planning services for informational purposes. We are not lawyers, accountants, or registered investment advisors unless specifically stated. Always consult appropriate professionals for legal, tax, or investment advice.
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600">
              To the maximum extent permitted by law, ProsperBridge shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use or inability to use our services, even if we have been advised of the possibility of such damages.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600">
              All content, materials, and intellectual property on our website and in our services remain the property of ProsperBridge. You may not reproduce, distribute, or create derivative works without our written permission.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-slate-50 rounded-xl p-6">
              ...
              <p className="text-slate-600">Email: legal@prosperbridge.ca</p>
