...
const blogFAQs = [
  {
    question: "How is a cottage taxed when inherited in Ontario?",
    answer: "When inheriting a cottage in Ontario, the estate pays capital gains tax on the appreciation from purchase price to fair market value at death, with 50% of the gain taxable at the deceased's marginal rate (up to 53.53% in 2025). The cottage cannot be designated as a principal residence unless it was the deceased's only property. Beneficiaries inherit at the stepped-up fair market value, establishing their new cost base. Future sales trigger capital gains from this inherited value. Consider life insurance to cover the tax bill, which can be hundreds of thousands for long-held family cottages."
  },
  {
    question: "What are the best ownership structures for family cottages?",
    answer: "Family cottages can be held personally, jointly with right of survivorship, through a trust, or via a cottage corporation in 2025. Joint ownership avoids probate but limits control and exposes all owners to liability. Trusts provide control and succession planning but cost $3,000-10,000 to establish and maintain. Cottage corporations enable share transfers, usage agreements, and limited liability, ideal for multiple family members sharing ownership. Each structure has different tax implications - personal ownership allows principal residence exemption, while corporations face higher tax rates but enable income splitting."
  },
  {
    question: "How do families prevent cottage inheritance disputes?",
    answer: "Preventing cottage disputes requires proactive planning including family meetings before death, written cottage agreements covering usage schedules, maintenance responsibilities, expense sharing, buyout provisions, and dispute resolution in 2025. Consider creating a cottage fund for ongoing expenses, establishing clear decision-making processes, and documenting improvement contributions. Life insurance can equalize inheritances when some children want the cottage and others prefer cash. Professional mediation during planning prevents future litigation. Address emotional attachment openly - the cottage represents family memories, not just financial value."
  }
];

const keyTakeaways = [
  "Cottage inheritance triggers capital gains tax on appreciation",
  "Family meetings and agreements prevent future disputes",
  "Trust or corporation structures offer succession benefits",
  "Life insurance can cover tax bills and equalize inheritances",
  "Written usage and expense agreements are essential"
];
...
const quickAnswer = "Inheriting a cottage in Ontario triggers capital gains tax on the estate, often hundreds of thousands for long-held properties. Families should plan ownership structures (joint, trust, or corporation), establish usage agreements, and consider life insurance to cover taxes. Early family meetings and written agreements prevent disputes and preserve both the property and relationships for future generations.";
...
const BlogContent = () => (
  <>
    ...
    <div className="bg-red-50 border-l-4 border-red-600 p-6 mb-8">
      <h3 className="font-bold text-gray-900 mb-3">🚨 2025 Cottage Crisis Factors</h3>
      <ul className="space-y-2 text-gray-700">
        <li>• Capital gains inclusion rate increased to 66.67% (from 50%)</li>
        <li>• Muskoka cottage values up 180% since 2015</li>
        <li>• Average cottage tax bill on death: $275,000</li>
        <li>• 73% of cottages sold within 2 years of inheritance</li>
        <li>• Family disputes in 61% of multi-heir cottage transfers</li>
        <li>• Property tax increases averaging 8-12% annually</li>
      </ul>
    </div>
    ...
    <div className="bg-gray-50 p-6 rounded-lg mb-8">
      ...
      <ul className="space-y-2 text-gray-700 mb-4">
        <li>☐ Original purchase documents and price</li>
        <li>☐ History of capital improvements with receipts</li>
        <li>☐ Current market valuation or assessment</li>
        <li>☐ Annual carrying costs breakdown</li>
        <li>☐ Property tax history and projections</li>
        <li>☐ Insurance policies and claims history</li>
        <li>☐ Septic, well, and building inspection reports</li>
        <li>☐ Municipal zoning and shoreline regulations</li>
      </ul>
      
      <h4 className="font-bold text-gray-900 mb-3">Family Information Needed</h4>
      <ul className="space-y-2 text-gray-700">
        <li>☐ List of all potential heirs and their spouses</li>
        <li>☐ Each family member's financial capacity</li>
        <li>☐ Usage patterns and emotional attachment levels</li>
        <li>☐ Geographic proximity and ability to maintain</li>
        <li>☐ Next generation's interest and involvement</li>
      </ul>
    </div>
    ...
    <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8">
      ...
      <ul className="space-y-2 text-gray-700">
        <li>• Share favorite cottage memories</li>
        <li>• Discuss what the cottage means to each person</li>
        <li>• Establish ground rules for tomorrow's planning session</li>
        <li>• Acknowledge this is about preserving, not dividing</li>
        <li>• Set the tone: "We're planning for success, not failure"</li>
      </ul>
    </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <ul className="space-y-1 text-sm text-gray-700">
            ...
            <li>• Equal ownership clear</li>
            <li>• No corporate maintenance</li>
          </ul>
        </div>
        <div>
          <h5 className="font-semibold text-red-700 mb-2">❌ Cons</h5>
          <ul className="space-y-1 text-sm text-gray-700">
            <li>• Immediate tax on transfer</li>
            <li>• Creditor exposure</li>
            <li>• Divorce complications</li>
            <li>• Unanimous decisions needed</li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <ul className="space-y-1 text-sm text-gray-700">
            ...
            <li>• Flexible distributions</li>
            <li>• Professional management</li>
            <li>• 21-year tax deferral</li>
          </ul>
        </div>
        <div>
          <h5 className="font-semibold text-red-700 mb-2">❌ Cons</h5>
          <ul className="space-y-1 text-sm text-gray-700">
            <li>• Setup costs $15-25K</li>
            <li>• Annual fees $3-5K</li>
            <li>• 21-year rule complexity</li>
            <li>• Less individual control</li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm text-gray-700">
            ...
            <li>• Shareholder agreements needed</li>
    ...
    <div className="bg-yellow-50 border-l-4 border-yellow-600 p-6 mb-8">
      <h3 className="font-bold text-gray-900 mb-3">⚠️ Critical Consideration</h3>
    ...
    <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8">
      <h3 className="font-bold text-gray-900 mb-3">📅 Sample Annual Schedule</h3>
      
      <h4 className="font-semibold text-gray-800 mb-2">Peak Season (May-September)</h4>
      <ul className="space-y-1 text-gray-700 mb-3">
        <li>• Rotating 2-week blocks per family</li>
        <li>• Holiday weekends by annual lottery</li>
        <li>• One "family week" all together</li>
      </ul>
      
      <h4 className="font-semibold text-gray-800 mb-2">Off-Season (October-April)</h4>
      <ul className="space-y-1 text-gray-700">
        <li>• First-come, first-served with 2-week notice</li>
        <li>• Maintenance weekends assigned</li>
        <li>• Rental permitted with majority consent</li>
      </ul>
    </div>
    ...
    <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8">
      <h3 className="font-bold text-gray-900 mb-3">💡 PRE Optimization Strategy</h3>
      <ul className="space-y-2 text-gray-700">
        <li>• Calculate gain per year for house vs. cottage</li>
        <li>• Designate property with highest annual gain</li>
        <li>• Consider changing designation before death</li>
        <li>• One property per family unit (includes spouse)</li>
        <li>• "+1 rule" provides extra year of exemption</li>
        <li>• Document all years of use and ownership</li>
      </ul>
    </div>
    ...
    <div className="bg-red-50 border-l-4 border-red-600 p-6 mb-8">
      <h3 className="font-bold text-gray-900 mb-3">🚨 Mistakes That Destroy Cottage Plans</h3>
    ...
    <div className="bg-green-50 border-l-4 border-green-600 p-6 mb-8">
      <h3 className="font-bold text-gray-900 mb-3">✅ This Weekend's Checklist</h3>
      
      <h4 className="font-semibold text-gray-800 mb-2">Friday</h4>
      <ul className="space-y-1 text-gray-700 mb-3">
        <li>☐ Gather all cottage documents</li>
        <li>☐ Print discussion guides for everyone</li>
        <li>☐ Set meeting ground rules</li>
      </ul>
      
      <h4 className="font-semibold text-gray-800 mb-2">Saturday</h4>
      <ul className="space-y-1 text-gray-700 mb-3">
        <li>☐ Hold structured family meeting</li>
        <li>☐ Document all decisions and concerns</li>
        <li>☐ Assign follow-up responsibilities</li>
      </ul>
      
      <h4 className="font-semibold text-gray-800 mb-2">Sunday</h4>
      <ul className="space-y-1 text-gray-700 mb-3">
        <li>☐ Create summary document</li>
        <li>☐ Set 30-day follow-up date</li>
      ...
      <ul className="space-y-1 text-gray-700">
        ...
        <li>☐ Meet with estate lawyer</li>
        <li>☐ Consult tax advisor</li>
        <li>☐ Explore insurance options</li>
      </ul>
    </div>
